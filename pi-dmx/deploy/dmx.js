...
export class DmxSender {
    ...
    sock = null;
    connected = false;
    closed = false; // close() begärd → sluta återansluta
    reconnectScheduled = false; // undvik dubbla reconnect-timers
    lastSent = 0;
    minIntervalMs = 5; // 200 Hz default; overridden by setMaxHz()
