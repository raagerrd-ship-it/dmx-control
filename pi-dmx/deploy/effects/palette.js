...
let CURRENT_PALETTE = ALL_SECTORS;
/** Sätt aktiv palett (anropas av motorn per frame). */
export function setPalette(sectors) { CURRENT_PALETTE = sectors; }
/** Aktiv palett (för t.ex. scenic-anchor-tonen). */
export function currentPalette() { return CURRENT_PALETTE; }
/** Gyllene-snitt-vandring 0–5, mappad in i den aktiva paletten. */
export function mixedSector(n) {
