...
export const duel = {
    key: "duel", label: "Duell", tier: "full", modulate: { energy: true, pulse: false }, section: ["high"], toggle: true,
    ...
    render(c) {
        ...
        if (isOuter)
            return c.hsv(hueResp, 1 - resp * 0.5, Math.min(1, 0.06 + resp * 0.9 + call * 0.15 + c.punch * 0.3));
