...
export type Mode = "smart" | "stegring" | "andrum" | "sug" | "vagbrytare" | "nedrakning" | "fyrverkeri" | "drops" | "party" | "chase" | "wave" | "breathe" | "snap" | "bounce" | "mono" | "aurora" | "pulse" | "strobe" | "rave" | "eq" | "gallop" | "twin" | "ripple" | "gravity" | "drumkit" | "split" | "subbreath" | "duel" | "airglow" | "tide" | "drift" | "pendel" | "viska" | "backbeat" | "tick" | "stege" | "eko" | "hjarta" | "sol" | "konfetti" | "sopa" | "varannan" | "forvarning" | "basgang" | "tyngdlyft" | "uvpuls" | "frasraknare" | "blackout";
...
export interface EngineConfig {
   ...
   *  maxBright   0.05..1.0  — tak på ringens ljusstyrka (5V-drift, 0.40 default håller strömmen låg).
  ...
  /** cal = vitbalans-, max-ljus- och gamma-kalibrering per slinga.
   *  rGain/gGain/bGain/maxBrightness 0..1 (default 1,1,1,1). gamma 0.3..3.0 (default 1.0
   *  = linjär; >1 mörknar botten, <1 ljusnar botten). Sidecarn applicerar dessa på
