...
const MODE_CYCLE: Mode[] = ["smart", "drops", "party", "chase", "wave", "cycle", "breathe", "tide", "snap", "bounce", "mono"];
...
if (!["smart","drops","party","chase","wave","cycle","breathe","tide","snap","bounce","mono","blackout"].includes(cfg.mode)) cfg.mode = "smart";
