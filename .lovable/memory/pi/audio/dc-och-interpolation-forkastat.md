...
Behållet från samma runda: löpande summa-av-kvadrater för RMS, sqrt bara i basbanden + effektviktad centroid KALIBRERAD som `sqrt(1.47·c)` (mätt p10/p50/p90 0.176/0.223/0.353 mot magnitudviktade 0.194/0.254/0.343 — samma skala för riser-grenen och färgtemperaturen), `scoreEnv`-ringen läst i två raka block, `magBig` kapad vid band 8-taket, takt-grid-grinden på `wallNow()`.
