...
Behållet från samma runda: löpande summa-av-kvadrater för RMS, sqrt bara i basbanden + effektviktad centroid, `scoreEnv`-ringen läst i två raka block, `magBig` kapad vid band 8-taket, takt-grid-grinden på `wallNow()`.
